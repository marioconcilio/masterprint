...
(function() {
  jQuery(function() {
    ...
    return $('#cliente_cep').mask('00000-000');
  });
...
(function() {
  jQuery(function() {
    var calculate;
    calculate = function() {
      var comp, dolar, larg, price, total;
    ...
    $('body').on('keyup', '.blq-calculable', function() {
      calculate();
    });
    $('body').on('change', '#blanqueta_blanqueta_lona_id', function() {
      calculate();
    });
    $('#blanqueta_larg').mask('#');
    return $('#blanqueta_comp').mask('#');
  });
...
(function() {
  jQuery(function() {
    ...
    $('body').on('keyup', '.chp-calculable', function() {
      calculate();
    });
    $('body').on('change', '#chapa_chapa_marca_id', function() {
      calculate();
    });
    $('#chapa_larg').mask('#');
    return $('#chapa_comp').mask('#');
  });
...
(function() {
  jQuery(function() {
    var calculate;
    calculate = function() {
      var currency, dolar, mil, total, un;
    ...
    $('body').on('keyup', '.env-calculable', function() {
      calculate();
    });
    $('body').on('change', '#envelope_moeda', function() {
      calculate();
    });
    $('#envelope_larg').mask('#');
    $('#envelope_comp').mask('#');
    $('#envelope_grs').mask('#');
    $('#envelope_un').mask('#');
    return $('#envelope_preco_milheiro').mask('#.##0,00', {
      reverse: true,
      placeholder: '0,00'
    });
  });
...
(function() {
  jQuery(function() {
    return $('#quimico_preco').mask('#.##0,00', {
      reverse: true,
      placeholder: '0,00'
    });
  });
...
(function() {
  jQuery(function() {
    var calculate;
    calculate = function() {
      var currency, dolar, kg, total, un;
    ...
    $('body').on('keyup', '.tin-calculable', function() {
      calculate();
    });
    $('body').on('change', '#tinta_moeda', function() {
      calculate();
    });
    $('#tinta_un').mask('#0,0', {
      reverse: true,
    ...
    return $('#tinta_preco_kg').mask('#.##0,00', {
      reverse: true,
      placeholder: '0,00'
    });
  });
...
(function() {
  jQuery(function() {
    return $('#variado_preco').mask('#.##0,00', {
      reverse: true,
      placeholder: '0,00'
    });
  });
